...
pub struct PowerShellGen<'key, 'b>
    where 'key: 'b
{
    p: &'b Parser<'key, 'b>,
}

impl<'key, 'b> PowerShellGen<'key, 'b> {
    pub fn new(p: &'b Parser<'key, 'b>) -> Self { PowerShellGen { p: p } }
...
fn generate_inner<'key, 'b>(p: &Parser<'key, 'b>, previous_command_name: &str) -> (String, String) {
