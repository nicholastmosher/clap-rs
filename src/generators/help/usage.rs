...
pub fn create_error_usage<'key, 'other>(p: &Parser<'key, 'other>,
                                  matcher: &'other ArgMatcher<'key>,
                                  extra: Option<&str>)
                                  -> String {
...
pub fn get_required_usage_from<'key, 'other>(p: &Parser<'key, 'other>,
                                       reqs: &[&'key str],
                                       matcher: Option<&ArgMatcher<'key>>,
                                       extra: Option<&str>,
                                       incl_last: bool)
                                       -> VecDeque<String> {
