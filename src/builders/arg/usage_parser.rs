...
impl<'key> UsageParser<'key> {
    fn new(usage: &'key str) -> Self {
    ...
    pub fn from_usage(usage: &'key str) -> Self {
        debugln!("UsageParser::from_usage;");
        UsageParser::new(usage)
    }

    pub fn parse(mut self) -> Arg<'key, 'key> {
    ...
    fn name(&mut self, arg: &mut Arg<'key, 'key>) {
    ...
    fn short_or_long(&mut self, arg: &mut Arg<'key, 'key>) {
    ...
    fn long(&mut self, arg: &mut Arg<'key, 'key>) {
    ...
    fn short(&mut self, arg: &mut Arg<'key, 'key>) {
    ...
    fn help(&mut self, arg: &mut Arg<'key, 'key>) {
...
mod test {
    ...
    fn nonascii() {
        ...
        let a = Arg::from_usage("<üñíčöĐ€> 'keySCII'");
        ...
        let a = Arg::from_usage("--üñíčöĐ€ 'keyōṫ ASCII'");
        assert_eq!(a.b.name, "üñíčöĐ€");
