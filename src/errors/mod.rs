...
impl Error {
    ...
    #[doc(hidden)]
    pub fn argument_conflict<'key, 'other, A, O, U>(arg: &A,
                                              other: Option<O>,
                                              usage: U,
                                              color: fmt::ColorWhen)
                                              -> Self
    ...
    #[doc(hidden)]
    pub fn empty_value<'key, 'other, A, U>(arg: &A, usage: U, color: fmt::ColorWhen) -> Self
        where A: AnyArg<'key, 'other> + Display,
              U: Display
    {
        let c = fmt::Colorizer {
    ...
    #[doc(hidden)]
    pub fn invalid_value<'a, 'other, B, G, A, U>(bad_val: B,
                                             good_vals: &[G],
                                             arg: &A,
                                             usage: U,
                                             color: fmt::ColorWhen)
    ...
    #[doc(hidden)]
    pub fn too_many_values<'a, 'other, V, A, U>(val: V,
                                            arg: &A,
                                            usage: U,
                                            color: fmt::ColorWhen)
                                            -> Self
    ...
    #[doc(hidden)]
    pub fn too_few_values<'a, 'other, A, U>(arg: &A,
                                        min_vals: u64,
                                        curr_vals: usize,
                                        usage: U,
                                        color: fmt::ColorWhen)
                                        -> Self
        where A: AnyArg<'a, 'other> + Display,
              U: Display
    {
        let c = fmt::Colorizer {
            use_stderr: true,
    ...
    #[doc(hidden)]
    pub fn value_validation<'a, 'other, A>(arg: Option<&A>, err: String, color: fmt::ColorWhen) -> Self
        where A: AnyArg<'a, 'other> + Display
    {
        let c = fmt::Colorizer {
            use_stderr: true,
    ...
    #[doc(hidden)]
    pub fn wrong_number_of_values<'a, 'other, A, S, U>(arg: &A,
                                                   num_vals: u64,
                                                   curr_vals: usize,
                                                   suffix: S,
                                                   usage: U,
    ...
    #[doc(hidden)]
    pub fn unexpected_multiple_usage<'a, 'other, A, U>(arg: &A, usage: U, color: fmt::ColorWhen) -> Self
        where A: AnyArg<'a, 'other> + Display,
              U: Display
    {
        let c = fmt::Colorizer {
