...
pub fn did_you_mean<'key, T: ?Sized, I>(v: &str, possible_values: I) -> Option<&'key str>
    where T: AsRef<str> + 'key,
...
pub fn did_you_mean<'key, T: ?Sized, I>(_: &str, _: I) -> Option<&'key str>
    where T: AsRef<str> + 'key,
          I: IntoIterator<Item = &'key T>
{
    None
